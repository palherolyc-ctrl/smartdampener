...
uint16 HalPeripheral_ProcessEvent( uint8 task_id, uint16 events )
{
    ...
    */
    ...
    if( events & KEY_DEMO_LONG_PRESS_EVT)
    {
        ...
        {
            if(key_state.key[i].state ==(key_state_e)HAL_KEY_EVT_PRESS)
            {
